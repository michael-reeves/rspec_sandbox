...
describe "Expectation Matchers" do
  ...
  describe "truthiness matchers" do
    ...
    it "will match true/false" do
      ...
      expect(0).not_to be(true) # 0 is not exactly true in ruby
      expect(0).not_to be(false) # nor is it exactly false
    end
    ...
    it "will match truthy/falsey" do
      ...
      expect(0).not_to be_falsey # instead of falsey
    end
    ...
    it "will match nil" do
      ...
      expect(false).not_to be(nil) # nil only, just like #nil?
      expect(0).not_to be(nil) # this would never be the case in ruby
    end
  ...
  describe "collection matchers" do
    ...
    it "will match arrays" do
      ...
      expect(array).not_to eq([3, 2, 1]) # order doesn't match
    ...
    it "will match hashes" do
      ...
      expect(hash).not_to include({'a' => 1, 'c' => 3}) # this supposedly
      # will work in Rails,
      # but not in Ruby
    end
  ...
  describe "other useful matchers" do
    ...
    it "will match objects types" do
    ...
    it "will match class instances with #have_attributes" do
      ...
      expect(car).to have_attributes(:make => 'Dodge',
                                     :year => 2010,
                                     :color => 'green')
    ...
    it "will match anything with #satisfy" do
      ...
      expect(10).to satisfy do |value|
        (value >= 5) and (value <=10) and (value % 2 == 0)
      end
    end
  ...
  describe "observation matchers" do
    ...
    it "will match when output is generated" do
      # observes output sent to $stdout and $stderr
  ...
  describe "composing matchers" do
    ...
    it "will match using noun-phrase aliases for matchers" do
      ...
      # http://rspec.info/documentation/3.2/rspec-expectations/RSpec/Matchers.html
